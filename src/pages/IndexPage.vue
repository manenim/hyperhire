...
import { useMediaQuery } from "../composable";
      ...
      <div class="banner">
        <div class="left" style="">
          <div class="left-top">
            ...
            <div
              class="text-white banner-text"
              style="font-size: 2rem; margin-bottom: 0.6rem"
              v-motion
...
개발자가 필요하신가요?            </p>
          ...
          <div
            class="left-bottom row justify-between"
          ...
          >
            ...
            <div
              ...
              :delay="200"
            >
              <div class="sub-item-header text-white" style="">
                평균 월 120만원
              </div>
        ...
        <div class="right">
          <img src="img/chat2.svg" alt="chat" />
          <HeroCarousel />
        </div>
      </div>
      <div
        class="slider"
        style="width: 92%; margin-left: auto"
        v-motion
        :initial="{ opacity: 0 }"
        :enter="{ opacity: 1, scale: 1 }"
        :duration="500"
